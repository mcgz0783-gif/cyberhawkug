...
const Index = () => {
  return (
    <Layout>
      <SEO title="CyberHawk-UG — Cybersecurity for East Africa" description="Elite threat intelligence, penetration testing, and incident response services protecting Uganda's digital infrastructure." path="/" jsonLd={[organizationJsonLd, websiteJsonLd]} />
      {/* Hero Section */}
